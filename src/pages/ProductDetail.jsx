        ...
        <div>
          ...
          >
            {product.images.map((img, i) => (
              <SwiperSlide key={i}>
                <img src={img} alt={`Slide ${i}`} className="w-full h-96 object-cover" />
              </SwiperSlide>
            ))}
          </Swiper>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            <button
              ...
              className="px-5 py-2 bg-red-600 text-white rounded-full hover:bg-red-700 flex items-center gap-2"
            >
            ...
            <a
              ...
              className="px-5 py-2 bg-green-600 text-white rounded-full hover:bg-green-700 flex items-center gap-2"
            >
